...
(function (){
    ...
    var instanceApi = {},
        ...
        promiseFn = function(_resolve, _reject){
          ...
          encapsulation = _fnPartial(runCtx, encapsulateRunInstance,
              instanceApi, safe(_resolve), safe(_reject), taskEvents
          );
          //encapsulateRunInstance.call(runCtx,
          //    safe(_resolve), safe(_reject),
          //    taskEvents, );
  ...
  function encapsulateRunInstance(instanceApi, resolveSafe, rejectSafe, taskEvents, promise) {
  ...
  function proceedDescriptionFn(instanceApi) {
    ...
    if (safe(thisTask, descriptionFn)(
      ...
      ctx.currentTimeout = defer.call(ctx, 0, function(){
        delete this.currentTimeout;
        instanceApi.goRunning();
        //proceedExec.call(this, instanceApi);
