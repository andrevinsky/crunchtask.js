...
Task = window.Task = (function (){
	...
	function proceedResults(argsSinkState) {
		...
		dispatchHandler(this.handlers, status, function(nextTask){
			if (nextTask && (nextTask instanceof Task)) {
	...
	Task.prototype.then = function(newTaskSuccess, newTaskFail, newTaskException){
	...
	Task.prototype.done = function(newTaskSuccess){
		recordHandler(this.handlers, 'success', newTaskSuccess);
		return this;
	};

	Task.prototype.fail = function(newTaskFail){
		recordHandler(this.handlers, 'failure', newTaskFail);
		return this;
	};

	Task.prototype.always = function(newTaskFail){
	...
	function Task(descriptionFn){
		if (!(this instanceof Task)) return new Task(descriptionFn /*(inFn, doFn(q))*/ );
